...
>
> - 🔧 **SSL 证书修复**：API 域名从 web.api.115.com 修正为 webapi.115.com / life.115.com
> - 🛣️ **路径解析**：新增三级降级机制（缓存→API→降级），不再依赖 API 返回 file_path
> - 🔄 **域名轮换**：webapi ↔ proapi 自动切换，规避 115 风控
> - ⏱️ **轮询优化**：默认间隔从 30 秒调整为 10 秒，事件更及时
> - 🔐 **Cookie 认证**：修复扫码登录请求格式和动态 clientType
